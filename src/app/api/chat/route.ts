...
export async function POST(req: Request) {
  try {
    ...
    try {
        ...
        const sys_prompt = "You are a financial AI assistant. The user will ask you questions about their spending. You must ONLY answer based on the provided transaction data. Do NOT answer general knowledge questions. If they ask something unrelated to their spending, refuse to answer.";
